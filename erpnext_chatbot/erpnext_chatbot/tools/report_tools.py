...
from erpnext_chatbot.utils.permissions import validate_report_access
from erpnext_chatbot.utils.response_formatter import format_report_for_ai
from erpnext_chatbot.utils.sanitization import validate_report_name
...
def _validate_filters(filters: Dict[str, Any], user: str) -> Dict[str, Any]:
    ...
    Returns:
        Validated filters
    """
    from erpnext_chatbot.utils.permissions import validate_company_access
