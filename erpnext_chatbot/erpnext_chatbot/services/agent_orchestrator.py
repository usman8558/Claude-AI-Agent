...
from erpnext_chatbot.services.audit_logger import log_query, log_tool_call
from erpnext_chatbot.tools.finance_tools import FINANCE_TOOLS, TOOL_FUNCTIONS as FINANCE_TOOL_FUNCTIONS
from erpnext_chatbot.tools.report_tools import REPORT_TOOLS, TOOL_FUNCTIONS as REPORT_TOOL_FUNCTIONS
...
def process_message(
    ...
    """
    from erpnext_chatbot.ai_chatbot.doctype.chat_message.chat_message import ChatMessage
...
def execute_tool(
    ...
    """
    from erpnext_chatbot.tools.base_tool import PermissionDeniedError
